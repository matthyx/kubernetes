...
var map_Container = map[string]string{
	...
	"startupProbe":             "Periodic probe of container service startup. Disables other probes until succeeded. Container will be restarted if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes",
...
var map_ContainerStatus = map[string]string{
	...
	"containerID":  "Container's ID in the format 'docker://<container_id>'.",
	"started":      "Specifies whether the container has passed its startup probe.",
}
